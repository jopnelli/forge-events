...
export const AtlassianContext = React.createContext<AtlassianContext>({loading: true, forgeContext: null});
type AtlassianContext = { loading: boolean, forgeContext: ForgeContext | null };
 ...
 */
export const AtlassianContextProvider = ({children}: { children: ReactElement | ((params: AtlassianContext) => ReactElement) }) => {
